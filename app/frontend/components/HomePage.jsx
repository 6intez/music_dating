...
const HomePage = () => {
  return (
    <div className="relative py-12 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 min-h-screen text-white overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen-[65] text-center px-4 sm:px-6 md:px-8 py-4">
        ...
        <p className="text-lg sm:text-2xl mb-8 opacity-90 animate__animated animate__fadeIn animate__delay-2s">
          Подключайся к лучшим специалистам и развивай свои проекты с помощью
          современных технологий.
        </p>

        <a href="/users/sign_up" className="bg-blue-500 sm:text-xl hover:bg-blue-700 text-white font-bold py-5 px-9 rounded-full shadow-xl transform transition duration-500 ease-in-out hover:scale-110 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-300">
        ...
        <div className="flex flex-col md:flex-row items-center text-center md:text-left">
          <div className="md:w-1/3 mb-8 md:mb-0">
            <img
              src={PhoneImage}
              alt="Phone"
              className="mx-auto w-1/3 md:w-1/2 rounded-lg shadow-lg"
            />
          </div>
          <div className="md:w-1/2">
            ...
            <p className="text-lg sm:text-2xl opacity-90 mb-8">
